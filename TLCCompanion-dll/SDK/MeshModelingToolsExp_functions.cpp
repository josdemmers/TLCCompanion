...
// Function MeshModelingToolsExp.UVTransferToolProperties.GetDestUVChannelNames
// (Final, Native, Private, Const)
// Parameters:
// const TArray<class FString>             ReturnValue                                            (ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)

const TArray<class FString> UUVTransferToolProperties::GetDestUVChannelNames() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UVTransferToolProperties", "GetDestUVChannelNames");

	Params::UVTransferToolProperties_GetDestUVChannelNames Parms{};
...
// Function MeshModelingToolsExp.UVTransferToolProperties.GetSourceUVChannelNames
// (Final, Native, Private, Const)
// Parameters:
// const TArray<class FString>             ReturnValue                                            (ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)

const TArray<class FString> UUVTransferToolProperties::GetSourceUVChannelNames() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UVTransferToolProperties", "GetSourceUVChannelNames");

	Params::UVTransferToolProperties_GetSourceUVChannelNames Parms{};
