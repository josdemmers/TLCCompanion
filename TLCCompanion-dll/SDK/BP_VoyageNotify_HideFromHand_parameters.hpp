...
// Function BP_VoyageNotify_HideFromHand.BP_VoyageNotify_HideFromHand_C.Received_Notify
// 0x0078 (0x0078 - 0x0000)
struct BP_VoyageNotify_HideFromHand_C_Received_Notify final
{
public:
	...
	class AVoyageWeapon*                          K2Node_DynamicCast_AsVoyage_Weapon;                // 0x0068(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_1;                     // 0x0070(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_VoyageNotify_HideFromHand_C_Received_Notify;
