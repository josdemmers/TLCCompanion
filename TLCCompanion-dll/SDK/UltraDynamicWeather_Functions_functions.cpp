...
void UUltraDynamicWeather_Functions_C::Get_Current_Temperature_·_𝖴𝖣𝖶(EUDS_TemperatureType Scale, bool Apply_Interior_Temperature, class UObject* __WorldContext, double* Temperature)
{
	static class UFunction* Func = nullptr;
