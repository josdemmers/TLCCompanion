...
// 0x0010 (0x0010 - 0x0000)
struct UVTransferToolProperties_GetDestUVChannelNames final
{
public:
	TArray<class FString>                         ReturnValue;                                       // 0x0000(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_UVTransferToolProperties_GetDestUVChannelNames;

// Function MeshModelingToolsExp.UVTransferToolProperties.GetSourceUVChannelNames
// 0x0010 (0x0010 - 0x0000)
struct UVTransferToolProperties_GetSourceUVChannelNames final
{
public:
	TArray<class FString>                         ReturnValue;                                       // 0x0000(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_UVTransferToolProperties_GetSourceUVChannelNames;
