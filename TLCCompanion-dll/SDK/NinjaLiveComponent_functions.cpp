...
// Function NinjaLiveComponent.NinjaLiveComponent_C.ResetTempArrays
// (Public, BlueprintCallable, BlueprintEvent)

void UNinjaLiveComponent_C::ResetTempArrays()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NinjaLiveComponent_C", "ResetTempArrays");
