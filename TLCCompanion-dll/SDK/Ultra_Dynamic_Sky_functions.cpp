...
void AUltra_Dynamic_Sky_C::Approximate_Real_Sun_Moon_and_Stars(double Time_of_Day_0, bool Only_Calculate_Sun, struct FVector* Sun_Vector, struct FVector* Moon_Vector, double* Real_Phase, struct FVector* Phase_Alignment, double* Celestial_Orbit, struct FLinearColor* Celestial_Yaw)
{
	static class UFunction* Func = nullptr;
...
// Function Ultra_Dynamic_Sky.Ultra_Dynamic_Sky_C.Construct Volumetric Cloud Light Rays
// (Protected, BlueprintCallable, BlueprintEvent)

void AUltra_Dynamic_Sky_C::Construct_Volumetric_Cloud_Light_Rays()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Sky_C", "Construct Volumetric Cloud Light Rays");
...
void AUltra_Dynamic_Sky_C::Current_Solar_Eclipse_Values(struct FLinearColor* Tint_Color, double* Eclipse_Percent_0)
{
	static class UFunction* Func = nullptr;
...
// (Protected, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    Startup_Tick                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AUltra_Dynamic_Sky_C::Tick_Function(bool Startup_Tick)
{
	static class UFunction* Func = nullptr;
	...
	Params::Ultra_Dynamic_Sky_C_Tick_Function Parms{};

	Parms.Startup_Tick = Startup_Tick;
...
// (Protected, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// double                                  Intensity_Multiplier                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FLinearColor*                    Bottom                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FLinearColor*                    Top                                                    (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AUltra_Dynamic_Sky_C::Volumetric_Cloud_Ambient_Light_Color(double Intensity_Multiplier, struct FLinearColor* Bottom, struct FLinearColor* Top)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Intensity_Multiplier = Intensity_Multiplier;
