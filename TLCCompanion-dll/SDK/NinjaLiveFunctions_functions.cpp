...
// bool                                    PainterV2                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UObject*                          __WorldContext                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// bool*                                   HitValid                                               (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UNinjaLiveFunctions_C::TraceOverlap(const struct FVector& Start, const struct FVector& End, double TracelineOvershoot, ETraceTypeQuery TraceChannel, TArray<class AActor*>& FluidNinjaLIVEActors, bool PainterV2, class UObject* __WorldContext, struct FLinearColor* HitUV, struct FVector* TracePosition, bool* HitValid)
{
	static class UFunction* Func = nullptr;
