...
DUMPER7_ASSERTS_FBT_FlyToTarget_DebugParams;
...
public:
	...
	TDelegate<void(const struct FDoNNavigationQueryData& Data)> ResultHandler;                       // 0x02C8(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TDelegate<void(const struct FDonNavigationDynamicCollisionPayload& Data)> DynamicCollisionListener; // 0x02D8(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
