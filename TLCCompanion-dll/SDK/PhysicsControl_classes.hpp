...
public:
	...
	bool                                          bWarnAboutInvalidNames;                            // 0x02BC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2BD[0x3];                                      // 0x02BD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MaxNumControlsOrModifiersPerName;                  // 0x02C0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAttemptToRecreateDisabledControls;                // 0x02C4(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C5[0x1FB];                                    // 0x02C5(0x01FB)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void DestroyBodyModifier(const class FName Name_0, const bool bApplyToModifiersWithName, const bool bApplyToSetsWithName);
	void DestroyBodyModifiers(const TArray<class FName>& Names, const bool bApplyToModifiersWithName, const bool bApplyToSetsWithName);
	void DestroyBodyModifiersInSet(const class FName Set);
	void DestroyControl(const class FName Name_0, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	void DestroyControls(const TArray<class FName>& Names, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	...
	bool InvokeControlProfile(const class FName ProfileName, const class FName ControlSetMask, const class FName BodyModifierSetMask);
	void ResetBodyModifiersInSetToCachedBoneTransforms(const class FName SetName, const EResetToCachedTargetBehavior Behavior);
	void ResetBodyModifiersToCachedBoneTransforms(const TArray<class FName>& Names, const EResetToCachedTargetBehavior Behavior, const bool bApplyToModifiersWithName, const bool bApplyToSetsWithName);
	void ResetBodyModifierToCachedBoneTransform(const class FName Name_0, const EResetToCachedTargetBehavior Behavior, const bool bApplyToModifiersWithName, const bool bApplyToSetsWithName);
	bool ResetControlPoint(const class FName Name_0);
	void SetBodyModifierCollisionType(const class FName Name_0, const ECollisionEnabled CollisionType, const bool bApplyToModifiersWithName, const bool bApplyToSetsWithName);
	void SetBodyModifierData(const class FName Name_0, const struct FPhysicsControlModifierData& ModifierData, const bool bApplyToModifiersWithName, const bool bApplyToSetsWithName);
	void SetBodyModifierDatas(const TArray<class FName>& Names, const struct FPhysicsControlModifierData& ModifierData, const bool bApplyToModifiersWithName, const bool bApplyToSetsWithName);
	void SetBodyModifierDatasInSet(const class FName Set, const struct FPhysicsControlModifierData& ModifierData);
	void SetBodyModifierGravityMultiplier(const class FName Name_0, const float GravityMultiplier, const bool bApplyToModifiersWithName, const bool bApplyToSetsWithName);
	...
	void SetBodyModifierKinematicTargetSpace(const class FName Name_0, const EPhysicsControlKinematicTargetSpace KinematicTargetSpace, const bool bApplyToModifiersWithName, const bool bApplyToSetsWithName);
	void SetBodyModifierMovementType(const class FName Name_0, const EPhysicsMovementType MovementType, const bool bApplyToModifiersWithName, const bool bApplyToSetsWithName);
	void SetBodyModifierPhysicsBlendWeight(const class FName Name_0, const float PhysicsBlendWeight, const bool bApplyToModifiersWithName, const bool bApplyToSetsWithName);
	void SetBodyModifiersCollisionType(const TArray<class FName>& Names, const ECollisionEnabled CollisionType, const bool bApplyToModifiersWithName, const bool bApplyToSetsWithName);
	void SetBodyModifiersGravityMultiplier(const TArray<class FName>& Names, const float GravityMultiplier, const bool bApplyToModifiersWithName, const bool bApplyToSetsWithName);
	...
	void SetBodyModifiersInSetKinematicTargetSpace(const class FName Set, const EPhysicsControlKinematicTargetSpace KinematicTargetSpace);
	...
	void SetBodyModifiersKinematicTargetSpace(const TArray<class FName>& Names, const EPhysicsControlKinematicTargetSpace KinematicTargetSpace, const bool bApplyToModifiersWithName, const bool bApplyToSetsWithName);
	void SetBodyModifiersMovementType(const TArray<class FName>& Names, const EPhysicsMovementType MovementType, const bool bApplyToModifiersWithName, const bool bApplyToSetsWithName);
	void SetBodyModifierSparseData(const class FName Name_0, const struct FPhysicsControlModifierSparseData& ModifierData, const bool bApplyToModifiersWithName, const bool bApplyToSetsWithName);
	void SetBodyModifierSparseDatas(const TArray<class FName>& Names, const struct FPhysicsControlModifierSparseData& ModifierData, const bool bApplyToModifiersWithName, const bool bApplyToSetsWithName);
	void SetBodyModifierSparseDatasInSet(const class FName Set, const struct FPhysicsControlModifierSparseData& ModifierData);
	void SetBodyModifiersPhysicsBlendWeight(const TArray<class FName>& Names, const float PhysicsBlendWeight, const bool bApplyToModifiersWithName, const bool bApplyToSetsWithName);
	void SetBodyModifiersUpdateKinematicFromSimulation(const TArray<class FName>& Names, const bool bUpdateKinematicFromSimulation, const bool bApplyToModifiersWithName, const bool bApplyToSetsWithName);
	void SetBodyModifierUpdateKinematicFromSimulation(const class FName Name_0, const bool bUpdateKinematicFromSimulation, const bool bApplyToModifiersWithName, const bool bApplyToSetsWithName);
	...
	void SetControlAngularData(const class FName Name_0, const float Strength, const float DampingRatio, const float ExtraDamping, const float MaxTorque, const bool bEnableControl, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	void SetControlData(const class FName Name_0, const struct FPhysicsControlData& ControlData, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	void SetControlDatas(const TArray<class FName>& Names, const struct FPhysicsControlData& ControlData, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	void SetControlDatasInSet(const class FName Set, const struct FPhysicsControlData& ControlData);
	void SetControlDisableCollision(const class FName Name_0, const bool bDisableCollision, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	void SetControlEnabled(const class FName Name_0, const bool bEnable, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	void SetControlLinearData(const class FName Name_0, const float Strength, const float DampingRatio, const float ExtraDamping, const float MaxForce, const bool bEnableControl, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	void SetControlMultiplier(const class FName Name_0, const struct FPhysicsControlMultiplier& ControlMultiplier, const bool bEnableControl, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	void SetControlMultipliers(const TArray<class FName>& Names, const struct FPhysicsControlMultiplier& ControlMultiplier, const bool bEnableControl, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	...
	void SetControlParent(const class FName Name_0, class UPrimitiveComponent* ParentComponent, const class FName ParentBoneName, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	void SetControlParents(const TArray<class FName>& Names, class UPrimitiveComponent* ParentComponent, const class FName ParentBoneName, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	...
	void SetControlsDisableCollision(const TArray<class FName>& Names, const bool bDisableCollision, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	void SetControlsEnabled(const TArray<class FName>& Names, const bool bEnable, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	...
	void SetControlsInSetUseSkeletalAnimation(const class FName Set, const bool bUseSkeletalAnimation, const float AngularTargetVelocityMultiplier, const float LinearTargetVelocityMultiplier);
	void SetControlSparseData(const class FName Name_0, const struct FPhysicsControlSparseData& ControlData, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	void SetControlSparseDatas(const TArray<class FName>& Names, const struct FPhysicsControlSparseData& ControlData, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	void SetControlSparseDatasInSet(const class FName Set, const struct FPhysicsControlSparseData& ControlData);
	void SetControlSparseMultiplier(const class FName Name_0, const struct FPhysicsControlSparseMultiplier& ControlMultiplier, const bool bEnableControl, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	void SetControlSparseMultipliers(const TArray<class FName>& Names, const struct FPhysicsControlSparseMultiplier& ControlMultiplier, const bool bEnableControl, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	...
	void SetControlsUseSkeletalAnimation(const TArray<class FName>& Names, const bool bUseSkeletalAnimation, const float AngularTargetVelocityMultiplier, const float LinearTargetVelocityMultiplier, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	void SetControlTarget(const class FName Name_0, const struct FPhysicsControlTarget& ControlTarget, const bool bEnableControl, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	void SetControlTargetOrientation(const class FName Name_0, const struct FRotator& orientation, const float AngularVelocityDeltaTime, const bool bEnableControl, const bool bApplyControlPointToTarget, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	void SetControlTargetOrientations(const TArray<class FName>& Names, const struct FRotator& orientation, const float AngularVelocityDeltaTime, const bool bEnableControl, const bool bApplyControlPointToTarget, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	...
	void SetControlTargetPosition(const class FName Name_0, const struct FVector& position, const float VelocityDeltaTime, const bool bEnableControl, const bool bApplyControlPointToTarget, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	void SetControlTargetPositionAndOrientation(const class FName Name_0, const struct FVector& position, const struct FRotator& orientation, const float VelocityDeltaTime, const bool bEnableControl, const bool bApplyControlPointToTarget, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	void SetControlTargetPositions(const TArray<class FName>& Names, const struct FVector& position, const float VelocityDeltaTime, const bool bEnableControl, const bool bApplyControlPointToTarget, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	void SetControlTargetPositionsAndOrientations(const TArray<class FName>& Names, const struct FVector& position, const struct FRotator& orientation, const float VelocityDeltaTime, const bool bEnableControl, const bool bApplyControlPointToTarget, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	...
	void SetControlTargets(const TArray<class FName>& Names, const struct FPhysicsControlTarget& ControlTarget, const bool bEnableControl, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
	...
	void SetControlUseSkeletalAnimation(const class FName Name_0, const bool bUseSkeletalAnimation, const float AngularTargetVelocityMultiplier, const float LinearTargetVelocityMultiplier, const bool bApplyToControlsWithName, const bool bApplyToSetsWithName);
