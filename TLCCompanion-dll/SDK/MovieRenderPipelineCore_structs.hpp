...
{
public:
	TSet<class UMovieGraphNode*>                  VisitedNodes;                                      // 0x0000(0x0050)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic, TObjectPtr)
};
...
// ScriptStruct MovieRenderPipelineCore.MovieGraphTokenResolveContext
// 0x0010 (0x0010 - 0x0000)
struct alignas(0x08) FMovieGraphTokenResolveContext final
{
public:
	uint8                                         Pad_0[0x10];                                       // 0x0000(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
DUMPER7_ASSERTS_FMovieGraphTokenResolveContext;
...
{
public:
	TSet<class AActor*>                           MatchingActors;                                    // 0x0000(0x0050)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic, TObjectPtr)
	TSet<class UActorComponent*>                  MatchingComponents;                                // 0x0050(0x0050)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPublic, TObjectPtr)
};
...
public:
	...
	struct FFilePath                              PlayerExecutable;                                  // 0x0008(0x0010)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
