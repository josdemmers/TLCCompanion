...
{
public:
	class USoundBase*                             Sound;                                             // 0x0028(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
...
{
public:
	class UAudioComponent*                        AudioComponent;                                    // 0x0028(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
...
{
public:
	class USoundBase*                             Sound;                                             // 0x0028(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	...
	TArray<class UActiveSoundscapeColorVoice*>    SoundscapeColorVoicePool;                          // 0x0180(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
...
{
public:
	class UWorld*                                 World;                                             // 0x0028(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	TArray<class UActiveSoundscapeColor*>         ActiveSoundscapeColors;                            // 0x0030(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
...
{
public:
	TSet<struct FSoftObjectPath>                  SoundscapePaletteCollection;                       // 0x0038(0x0050)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
...
{
public:
	TMap<struct FGameplayTag, class USoundscapeColorPointHashCellDensity*> ColorPointHashMap;        // 0x0028(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
...
{
public:
	class USoundscapeColorPointHashMap*           ColorPointHashMapLOD1;                             // 0x0028(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	class USoundscapeColorPointHashMap*           ColorPointHashMapLOD2;                             // 0x0030(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	class USoundscapeColorPointHashMap*           ColorPointHashMapLOD3;                             // 0x0038(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	uint8                                         Pad_30[0x8];                                       // 0x0030(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<class USoundscapePalette*>               LoadedPaletteCollectionSet;                        // 0x0038(0x0050)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	...
	TMap<class USoundscapePalette*, class UActiveSoundscapePalette*> ActivePalettes;                 // 0x00F8(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	uint8                                         Pad_148[0x58];                                     // 0x0148(0x0058)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class USoundscapeColorPointHashMapCollection*> ColorPointHashMapCollections;              // 0x01A0(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	uint8                                         Pad_1B0[0x60];                                     // 0x01B0(0x0060)(Fixing Size After Last Property [ Dumper-7 ])
	class USoundscapeColorPointHashMap*           ColorPointHashMapLOD1;                             // 0x0210(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	class USoundscapeColorPointHashMap*           ColorPointHashMapLOD2;                             // 0x0218(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	class USoundscapeColorPointHashMap*           ColorPointHashMapLOD3;                             // 0x0220(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	class USoundscapeColorPointHashMap*           ActiveColorPointHashMap;                           // 0x0228(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
