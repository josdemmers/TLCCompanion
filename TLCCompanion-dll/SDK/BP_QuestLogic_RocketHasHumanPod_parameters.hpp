...
// Package: BP_QuestLogic_RocketHasHumanPod
...
// Function BP_QuestLogic_RocketHasHumanPod.BP_QuestLogic_RocketHasHumanPod_C.OnRun
// 0x0148 (0x0148 - 0x0000)
struct BP_QuestLogic_RocketHasHumanPod_C_OnRun final
{
public:
	...
	int32                                         NumHumans;                                         // 0x0030(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVoyageQuestLogicResult                K2Node_MakeStruct_VoyageQuestLogicResult;          // 0x00C8(0x0020)()
	class AActor*                                 CallFunc_ResolvePersistentActorReference_ReturnValue; // 0x00E8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AVoyageRocketActor*                     K2Node_DynamicCast_AsVoyage_Rocket_Actor;          // 0x00F0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class UVoyagePhysicalSnapSocketComponent*> CallFunc_K2_GetComponentsByClass_ReturnValue;  // 0x0100(0x0010)(ReferenceParm, ContainsInstancedReference)
	class UVoyagePhysicalSnapSocketComponent*     CallFunc_Array_Get_Item;                           // 0x0110(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UVoyagePhysicalSnapSocket*              CallFunc_Array_Get_Item_1;                         // 0x0120(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class AVoyageLazarusPOD*                      K2Node_DynamicCast_AsVoyage_Lazarus_POD;           // 0x0138(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_1;                     // 0x0140(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_QuestLogic_RocketHasHumanPod_C_OnRun;
