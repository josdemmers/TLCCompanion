...
public:
	...
	bool GetNodeValidationErrors(const class FName& InBranchName, const class UMovieGraphEvaluatedConfig* InEvaluatedConfig, TArray<class FText>* OutValidationErrors) const;
...
{
public:
	uint8                                         bOverride_RendererName : 1;                        // 0x00A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bOverride_RendererSubName : 1;                     // 0x00A8(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 RendererName;                                      // 0x00B0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 RendererSubName;                                   // 0x00C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	static class FString ResolveFormatArguments(const class FString& InFormatString, const struct FMovieGraphFilenameResolveParams& InParams, struct FMovieGraphResolveArgs* OutMergedFormatArgs);
...
public:
	...
	const TArray<class UMovieGraphConfig*> GetEvaluatedGraphs() const;
	...
	bool GetVariableStringValueByName(const class FString& InVariableName, const class FString& InDefaultValue, class FString* OutVariableValue) const;
	bool GetVariableValueByName(const class FString& InVariableName, class UMovieGraphValueContainer** OutVariableValue) const;
...
// Class MovieRenderPipelineCore.MovieGraphEvaluationNodeInjector
// 0x0000 (0x0000 - 0x0000)
class IMovieGraphEvaluationNodeInjector final
{
public:
	void InjectNodesPostEvaluation(const class FName& InBranchName, class UMovieGraphEvaluatedConfig* InEvaluatedConfig, TArray<class UMovieGraphSettingNode*>* OutInjectedNodes);

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("MovieGraphEvaluationNodeInjector")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"MovieGraphEvaluationNodeInjector")
	}
	static class IMovieGraphEvaluationNodeInjector* GetDefaultObj()
	{
		return GetDefaultObjImpl<IMovieGraphEvaluationNodeInjector>();
	}
...
DUMPER7_ASSERTS_IMovieGraphEvaluationNodeInjector;
...
public:
	...
	TSet<class UMovieGraphFileOutputNode*>        OutputNodesDataSentTo;                             // 0x0148(0x0050)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
...
// Class MovieRenderPipelineCore.MovieGraphModifierBase
// 0x0000 (0x0028 - 0x0028)
class UMovieGraphModifierBase : public UObject
{
public:
	void ApplyModifier(const class UWorld* World);
	class FText GetModifierName();
	void UndoModifier();

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("MovieGraphModifierBase")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"MovieGraphModifierBase")
	}
	static class UMovieGraphModifierBase* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMovieGraphModifierBase>();
	}
};
DUMPER7_ASSERTS_UMovieGraphModifierBase;
...
public:
	...
	TArray<class UMovieGraphModifierBase*>        Modifiers;                                         // 0x0030(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)

public:
	void AddLayerModifier(class UMovieGraphModifierBase* InModifier);
	void AddModifier(class UMovieGraphCollectionModifier* Modifier);
	void Apply(const class UWorld* World);
	void RemoveLayerModifier(class UMovieGraphModifierBase* Modifier);
	...
	TArray<class UMovieGraphModifierBase*> GetLayerModifiers() const;
...
{
public:
	TArray<class UMovieGraphRenderLayer*>         RenderLayers;                                      // 0x0038(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	class UMovieGraphRenderLayer*                 ActiveRenderLayer;                                 // 0x0048(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
{
public:
	uint8                                         bOverride_bCompositeOntoFinalImage : 1;            // 0x00D0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	bool                                          bCompositeOntoFinalImage;                          // 0x00D1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D2[0x76];                                      // 0x00D2(0x0076)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         bOverride_BurnInClass : 1;                         // 0x0148(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_149[0x7];                                      // 0x0149(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSoftClassPath                         BurnInClass;                                       // 0x0150(0x0020)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<TSubclassOf<class UObject>, class UMovieGraphBurnInWidget*> BurnInWidgetInstances;          // 0x0170(0x0050)(ExportObject, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
...
// Class MovieRenderPipelineCore.MovieGraphOutputBurnInNode
// 0x0058 (0x0218 - 0x01C0)
class UMovieGraphOutputBurnInNode final : public UMovieGraphBurnInNode
{
public:
	uint8                                         bOverride_OutputName : 1;                          // 0x01C0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_FileNameFormat : 1;                      // 0x01C0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_OutputRestriction : 1;                   // 0x01C0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_LayerNameFormat : 1;                     // 0x01C0(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1C1[0x7];                                      // 0x01C1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 OutputName;                                        // 0x01C8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSoftClassPath                         OutputRestriction;                                 // 0x01D8(0x0020)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 FileNameFormat;                                    // 0x01F8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 LayerNameFormat;                                   // 0x0208(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("MovieGraphOutputBurnInNode")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"MovieGraphOutputBurnInNode")
	}
	static class UMovieGraphOutputBurnInNode* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMovieGraphOutputBurnInNode>();
	}
};
DUMPER7_ASSERTS_UMovieGraphOutputBurnInNode;
...
public:
	...
	uint8                                         Pad_AA[0x6];                                       // 0x00AA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDirectoryPath                         OutputDirectory;                                   // 0x00B0(0x0010)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
// Class MovieRenderPipelineCore.MovieGraphMaterialParameterCollectionModifier
// 0x0170 (0x0198 - 0x0028)
class UMovieGraphMaterialParameterCollectionModifier final : public UMovieGraphModifierBase
{
public:
	TSoftObjectPtr<class UMaterialParameterCollection> MaterialParameterCollection;                  // 0x0028(0x0028)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class FName, float>                      ScalarParameterUpdates;                            // 0x0050(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	TMap<class FName, struct FLinearColor>        VectorParameterUpdates;                            // 0x00A0(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	uint8                                         Pad_F0[0xA0];                                      // 0x00F0(0x00A0)(Fixing Size After Last Property [ Dumper-7 ])
	TWeakObjectPtr<class UWorld>                  CachedWorld;                                       // 0x0190(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("MovieGraphMaterialParameterCollectionModifier")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"MovieGraphMaterialParameterCollectionModifier")
	}
	static class UMovieGraphMaterialParameterCollectionModifier* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMovieGraphMaterialParameterCollectionModifier>();
	}
};
DUMPER7_ASSERTS_UMovieGraphMaterialParameterCollectionModifier;

// Class MovieRenderPipelineCore.MovieGraphMaterialParameterCollectionModifierNode
// 0x0040 (0x00E8 - 0x00A8)
class UMovieGraphMaterialParameterCollectionModifierNode final : public UMovieGraphSettingNode
{
public:
	uint8                                         Pad_A8[0x8];                                       // 0x00A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bOverride_MaterialParameterCollection : 1;         // 0x00B0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_B1[0x7];                                       // 0x00B1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftObjectPtr<class UMaterialParameterCollection> MaterialParameterCollection;                  // 0x00B8(0x0028)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMovieGraphMaterialParameterCollectionModifier* Modifier;                                  // 0x00E0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("MovieGraphMaterialParameterCollectionModifierNode")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"MovieGraphMaterialParameterCollectionModifierNode")
	}
	static class UMovieGraphMaterialParameterCollectionModifierNode* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMovieGraphMaterialParameterCollectionModifierNode>();
	}
};
DUMPER7_ASSERTS_UMovieGraphMaterialParameterCollectionModifierNode;
...
// Class MovieRenderPipelineCore.MovieGraphModifierNodeInterface
// 0x0000 (0x0000 - 0x0000)
class IMovieGraphModifierNodeInterface final
{
public:
	...
	TArray<class FName> GetAllCollections() const;
	TArray<class UMovieGraphModifierBase*> GetAllModifiers() const;
	bool IsCollectionEnabled(const class FName& InCollectionName) const;
	bool SupportsCollections() const;

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("MovieGraphModifierNodeInterface")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"MovieGraphModifierNodeInterface")
	}
	static class IMovieGraphModifierNodeInterface* GetDefaultObj()
	{
		return GetDefaultObjImpl<IMovieGraphModifierNodeInterface>();
	}
...
DUMPER7_ASSERTS_IMovieGraphModifierNodeInterface;
...
public:
	...
	TSet<class FName>                             DisabledCollections;                               // 0x00E8(0x0050)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<uint32>                                  OverriddenShowFlags;                               // 0x0030(0x0050)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
public:
	...
	bool                                          bOverrideGrassCullDistanceScale;                   // 0x0091(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_92[0x2];                                       // 0x0092(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         GrassCullDistanceScale;                            // 0x0094(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOverrideGrassDensityScale;                        // 0x0098(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_99[0x3];                                       // 0x0099(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         GrassDensityScale;                                 // 0x009C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bFlushStreamingManagers;                           // 0x00A0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOverrideVirtualTextureFeedbackFactor;             // 0x00A1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A2[0x2];                                       // 0x00A2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         VirtualTextureFeedbackFactor;                      // 0x00A4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
