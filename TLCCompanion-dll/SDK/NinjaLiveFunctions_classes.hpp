...
public:
	...
	static void TraceOverlap(const struct FVector& Start, const struct FVector& End, double TracelineOvershoot, ETraceTypeQuery TraceChannel, TArray<class AActor*>& FluidNinjaLIVEActors, bool PainterV2, class UObject* __WorldContext, struct FLinearColor* HitUV, struct FVector* TracePosition, bool* HitValid);
