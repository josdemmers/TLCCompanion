...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0A726E20;
	constexpr int32 AppendString      = 0x0137CD50;
	constexpr int32 GNames            = 0x0A658DC0;
	constexpr int32 GWorld            = 0x0A8B1AA8;
	constexpr int32 ProcessEvent      = 0x015509C0;
